...
const photos = [
  {
    src: "https://res.cloudinary.com/dbgcwdes6/image/upload/v1777268144/Screenshot_2026-04-27_at_08.35.22_cww6a4.png",
      ...
      <section id="articles" className="py-20 md:py-28 bg-muted/30 border-y border-border">
        <div className="container">
          <SectionHeading
            ...
            description="Press features and articles about the campaign."
          />
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {articles.map((a) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block border border-border bg-background p-6 hover:border-primary transition-colors group"
              >
      ...
      <section id="photos" className="py-20 md:py-28 bg-background">
        <div className="container">
          <SectionHeading
            eyebrow="Photos"
            title="On the Ground"
            description="Snapshots from rallies, meetings and community visits across Nairobi."
          />
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {photos.map((p) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block aspect-[4/3] overflow-hidden border border-border bg-foreground/5 group"
              >
                <img
                  src={p.src}
                  alt={p.alt}
